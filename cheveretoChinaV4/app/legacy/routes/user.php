...
return function (Handler $handler) {
    ...
    if (getSetting('website_mode') == 'personal' && $user['id'] == getSetting('website_mode_personal_uid') && $handler->requestArray()[0] == 'user') {
        redirect(getSetting('website_mode_personal_routing'));
    }
