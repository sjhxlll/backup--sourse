 ...
 * Also used on CheveretoChina V3
    ...
    try {
        ...
        if ($verify === []) {
            if ((getSetting('api_v1_key') ?? '') == '') {
                throw new Exception("API V1 public key can't be null. Go to your dashboard and set the API v1 key.", 0);
            }
