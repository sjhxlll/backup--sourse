...
$settings_updates = [
    '3.0.0' => [
        ...
        'email_from_email' => 'noreply@idc.moe',
        'email_from_name' => 'CheveretoChina',
        'email_incoming_email' => 'incoming@idc.moe',
        'email_mode' => 'mail',
        'email_smtp_server' => '',
        ...
        'website_description' => '一个由 Chevereto 提供的自托管图床',
        'website_doctitle' => 'CheveretoChina 图床程序',
        'website_name' => 'CheveretoChina',
    ],
    '3.0.1' => null,
    '3.0.2' => null,
    '3.0.3' => null,
...
if (hasEnvDbInfo()) {
    ...
    if (stripos($sqlServerVersion, 'MariaDB') !== false) {
        ...
        $explodeSqlVersion = explode('-', $sqlServerVersion);
