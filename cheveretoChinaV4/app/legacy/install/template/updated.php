...
<h1><i class="far fa-check-circle"></i> 更新完成</h1>
<p><?php echo strtr('CheveretoChina 已成功更新。 您现在可以进入<a href="%u">仪表盘</a>配置您的图床。', ['%s' => get_chevereto_version(true), '%u' => get_base_url('dashboard')]); ?></p>
<div>
