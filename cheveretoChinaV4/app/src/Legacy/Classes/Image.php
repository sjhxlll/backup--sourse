...
class Image
{
    ...
    public static function uploadToWebsite(
        ...
        try {
            ...
            $storage_id = null;
            $get_active_storages = Storage::get(['is_active' => 1]);
    ...
    public static function insert(array $image_upload, array $values = []): int
    {
        ...
        $original_exifdata = $image_upload['source']['image_exif'] ? json_encode(array_utf8encode($image_upload['source']['image_exif'])) : null;
