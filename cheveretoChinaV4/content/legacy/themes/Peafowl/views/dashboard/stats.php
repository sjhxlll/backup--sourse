...
var options = {
    ...
    // theme: {
    //     mode: '<?php echo Handler::var('theme_tone'); ?>',
    // }
};
    ...
    chart.zoomX(
        ...
        <?php echo $max; ?>
					...
					<div class="overflow-auto text-align-center margin-top-20 margin-bottom-40">
						<a href="<?php echo get_base_url('dashboard/images'); ?>" class="stats-block c6 fluid-column display-inline-block" <?php if (Handler::var('totals')['images'] > 999999) {
