...
<div class="phablet-c1">
    <div class="input-label">
        ...
        <div class="c5 phablet-c1"><select type="text" name="website_https" id="website_https" class="text-input">
                <?php
                echo get_select_options_html(['auto' => _s('Automatic'), 'forced' => _s('Forced'), 'disabled' => _s('Disabled')], Settings::get('website_https')); ?>
            </select></div>
        ...
        <div class="input-below margin-top-10"><span class="highlight padding-5 display-inline-block"><i class="fas fa-exclamation-triangle"></i> <?php _se("This only controls the protocol used in the URLs, it won't turn your website into a valid HTTPS website unless your server is configured to support and use HTTPS."); ?></span></div>
    </div>
</div>
<hr class="line-separator">
<?php
...
<div class="input-label">
    ...
    <div class="c5 phablet-c1"><select type="text" name="website_mode" id="website_mode" class="text-input" data-combo="website-mode-combo">
            <?php
            echo get_select_options_html(['community' => _s('Community'), 'personal' => _s('Personal')], Settings::get('website_mode')); ?>
        </select></div>
...
<div id="website-mode-combo">
    <div data-combo-value="personal" class="switch-combo phablet-c1<?php if ((Handler::var('safe_post') ? Handler::var('safe_post')['website_mode'] : Settings::get('website_mode')) != 'personal') {
                echo ' soft-hidden';
            } ?>">
        <hr class="line-separator">
        <div class="input-label">
            <label for="website_mode_personal_uid"><?php _se('Personal mode target user'); ?></label>
            <div class="c3"><input type="number" min="1" name="website_mode_personal_uid" id="website_mode_personal_uid" class="text-input" value="<?php echo Settings::get('website_mode_personal_uid'); ?>" placeholder="<?php _se('User ID'); ?>" rel="tooltip" title="<?php _se('Your user id is: %s', Login::getUser()['id']); ?>" data-tipTip="right" data-required></div>
        ...
        <div class="input-label">
            ...
            <div class="c5"><input type="text" name="website_mode_personal_routing" id="website_mode_personal_routing" class="text-input" value="<?php echo Settings::get('website_mode_personal_routing'); ?>" placeholder="/"></div>
