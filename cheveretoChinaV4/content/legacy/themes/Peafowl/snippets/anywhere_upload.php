        	...
        	<div class="upload-box-heading c18 center-box">
				<div class="upload-box-status">
					<div data-group="upload">
						...
						<div class="heading device-mobile--hide"><a data-trigger="anywhere-upload-input"><?php _se('Drag and drop or paste %contents% here to upload', ['%contents%' => _s('files')]); ?></a></div>
						<div class="heading device-nonmobile--hide"><a data-trigger="anywhere-upload-input"><?php _se('Select the %contents% to upload', ['%contents%' => _s('files')]); ?></a></div>
                        <?php
				...
				<div class="input-label margin-bottom-0">
					...
					<div class="c7 margin-bottom-10">
						<select name="uploaded-embed-toggle" id="uploaded-embed-toggle" class="text-input" data-combo="uploaded-embed-toggle-combo">
                            <?php
                                $tpl = Handler::cond('moderate_uploads') ? 'embed_unapproved_tpl' : 'embed_share_tpl';
