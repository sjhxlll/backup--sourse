...
$(function () {
    ...
    if (
        ...
        var recaptchaLoadUrls = {
            2: "https://www.recaptcha.net/recaptcha/api.js?onload=reCaptchaCallback&render=explicit",
            3: "https://www.recaptcha.net/recaptcha/api.js?onload=reCaptchaCallback&render=" + CHV.obj.config.recaptcha.sitekey,
        };
        reCaptchaCallback = function () {
            ...
            switch(CHV.obj.config.recaptcha.version) {
                case 2:
                    grecaptcha
                        .render("g-recaptcha", {
                ...
                case 3:
                    grecaptcha
                        .execute(CHV.obj.config.recaptcha.sitekey, {action:'recaptcha_action'})
                        .then(function(token) {
                            document
        ...
        $.getScript(recaptchaLoadUrls[CHV.obj.config.recaptcha.version]);
    }
